    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_date', models.DateTimeField(auto_now_add=True, help_text='The date the record was created.')),
                ('modified_date', models.DateTimeField(auto_now=True, help_text='The date the record was last modified.')),
                ('name', models.SlugField(help_text='The name of the document type.', max_length=100, unique=True)),
        ...
        migrations.AddField(
            model_name='document',
            name='document_type',
            field=models.ForeignKey(help_text='The type of this document.', on_delete=django.db.models.deletion.PROTECT, related_name='documents', to='logomachy_core.DocumentType'),
        ),
    ]
